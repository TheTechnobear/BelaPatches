...
bool setup(BelaContext *context, void *userData)
{
	...
	printf("SR : audio %f , analog %f\n", context->audioSampleRate, context->analogSampleRate );
	printf("IN: audio channels %d , analog channels %d\n", context->audioInChannels, context->analogInChannels );
	printf("OUT: audio channels %d , analog channels %d\n", context->audioOutChannels, context->analogOutChannels );
	printf("Frames: audio %d , analog %d, digital %d\n", context->audioFrames, context->audioFrames, context->digitalFrames );
